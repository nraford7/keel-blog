...
mood: "structural"
hero: "structural-leakage.jpg"
hero_alt: "A dark vessel split by a hairline fracture, luminous teal liquid streaming through the crack — the container that was never closed"
---
...
![Adaptive leakage — a translucent membrane, selectively permeable, particles passing through and around](adaptive-leakage.jpg)
...
![Trickster leakage — an amber organism mid-transit through a translucent boundary, the membrane deforming to accommodate passage](trickster-leakage.jpg)
...
![Antigenic leakage — scar tissue overrunning its boundaries, reddish-amber growth consuming teal-blue healthy tissue from the center](antigenic-leakage.jpg)
